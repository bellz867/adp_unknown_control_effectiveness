function [xfNew,PHIfNew,GfNew,gfNew, PNew, QNew, thetaHatNew,GammaCLNew] = FaultTolUpdateEstimator(x,xf,PHIf,Gf,gf,P,Q,thetaHat,GammaCL,PHI,G,go,scriptYTYStackSum,scriptYTxStackSum,auxdata,dt)
...
dQ = -auxdata.L*Q + auxdata.kP1*PHIf'*((x-xf)/auxdata.kf)/clNorm +auxdata.kCL*scriptYTxStackSum; %Q matrix  dynamics
