...
for k = 1:auxdata.numpoints
    ...
    [ uk, uCostk,Gak] = FaultTolGetInput(gHatk,WaHat,sigPrimek,auxdata);%Get input input cost and musat(sigPrime(sgn()-Tanh())) term for WaHat
    ...
    criticSum = criticSum + omegak*(deltak)/rhok^2;
