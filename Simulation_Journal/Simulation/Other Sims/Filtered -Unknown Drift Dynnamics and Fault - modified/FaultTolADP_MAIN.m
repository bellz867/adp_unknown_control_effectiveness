...
clc;
clear;
% cd(C:\Users\pdeptula\Desktop\Repo stuff\[Journal] StaF ADP _ Unknown Drift and Control Effectiveness Fault\Simulation\Filtered -Unknown Drift Dynnamics and Fault - modified)
%-------------------------------------------------------------------------%
%--------------------------Setup------------------------------------------%
%-------------------------------------------------------------------------%
plotSoln = 1;
...
if compareToComplementaryPaper == 0;
    auxdata.InputKp1 = 0.01*eye(2).*(auxdata.NormDyn); %Gain for input if adding Kx inside saturation
else
