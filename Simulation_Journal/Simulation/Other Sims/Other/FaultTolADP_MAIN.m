...
clc;
clear;
cd('C:\Users\pdeptula\Desktop\Repo stuff\Unknown Fault StaF ADP\Simulation\Filtered -Unknown Drift Dynnamics and Fault')
%-------------------------------------------------------------------------%
%--------------------------Setup------------------------------------------%
%-------------------------------------------------------------------------%
plotSoln = 1;
...
%Set Times
auxdata.finalTime = 20; %Simulation end time in seconds
...
auxdata.InputKp1 = 0.004*eye(2).*(auxdata.NormDyn); %Gain for input if adding Kx inside saturation
auxdata.InputKp2 = 2;

% Weight Initial Conditions
auxdata.WcHat0 =  unifrnd(4,7,auxdata.nodes,1);%[0.4 0.4 0.4 0.4 0.4 0.4 0.4 0.4 0.4]'; ;[3.4, 3.2, 2.8]'; [3.2, 5.5, 3.1]';% [5.05, 5.9 3.48]';%
...
auxdata.kP1 = 0; %Gain for Least Square Matrices P and Q
