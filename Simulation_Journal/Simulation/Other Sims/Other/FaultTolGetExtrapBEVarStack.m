...
for k = 1:auxdata.numpoints;
    ...
    [ uk, uCostk,Gak,Gck] = FaultTolGetInput(xk,gHatk,WaHat,sigPrimek,auxdata);%Get input input cost and musat(sigPrime(sgn()-Tanh())) term for WaHat
    ...
    criticSum = criticSum + GammaADP*omegak*(deltak-Gck)/(rhok^2);
